object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  transformInt(2, x => {val y = x * 2; y * y});System.out.println("""res2: Int = """ + $show(res$2));$skip(426); 
  ...
  def toUpperCase(input: String): String = {
  	input.toUpperCase();
  };System.out.println("""toUpperCase: (input: String)String""");$skip(36); 
  
  
  println(toUpperCase("foo"));$skip(34); 
 	println(toUpperCase("foOORRe"));$skip(75); 
 	
 	def transform(x: String, f: String => String): String = {
 		f(x)
 	};System.out.println("""transform: (x: String, f: String => String)String""");$skip(35); val res$3 = 
  
  transform("foo", toUpperCase);System.out.println("""res3: String = """ + $show(res$3));$skip(42); val res$4 = 
  transform("food", x => x.toUpperCase());System.out.println("""res4: String = """ + $show(res$4))}
