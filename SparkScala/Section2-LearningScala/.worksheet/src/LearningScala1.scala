object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(128); 
  ...
  println(s"The s prefix isn't limited to variables; I can include any expression. Like ${1+2}");$skip(162); 
  ...
  var doublePi = piSinglePrecision * 2;System.out.println("""doublePi  : Float = """ + $show(doublePi ));$skip(54); ;
  
  println(f"Value of Double Pi is $doublePi%.3f");}
