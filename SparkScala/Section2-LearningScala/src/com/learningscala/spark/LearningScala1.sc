object LearningScala1 {
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = BonjourThere!
  println(immutableHelloThere)                    //> BonjourThere!
  ...
  var doublePi = piSinglePrecision * 2;           //> doublePi  : Float = 6.2831855
  
  println(f"Value of Double Pi is $doublePi%.3f");//> Value of Double Pi is 6.283
