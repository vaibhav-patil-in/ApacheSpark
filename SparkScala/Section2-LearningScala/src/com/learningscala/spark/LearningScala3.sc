object LearningScala3 {
  ...
  println(toUpperCase("foo"))                     //> FOO
 	println(toUpperCase("foOORRe"))           //> FOOORRE
 	
 	def transform(x: String, f: String => String): String = {
 		f(x)
 	}                                         //> transform: (x: String, f: String => String)String
  
  transform("foo", toUpperCase)                   //> res3: String = FOO
  transform("food", x => x.toUpperCase())         //> res4: String = FOOD
