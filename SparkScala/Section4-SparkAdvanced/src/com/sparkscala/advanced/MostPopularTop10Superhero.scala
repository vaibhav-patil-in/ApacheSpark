package com.sparkscala.advanced

import org.apache.spark._
import org.apache.spark.SparkContext._
import org.apache.log4j._

/** Find the Top 10 most popular superhero with the most co-appearances. */
object MostPopularTop10Superhero {
  ...
  def main(args: Array[String]) {
    ...
    // Sort Heroes by count
    val mostPopular = flipped.sortByKey(false);

    //Print Top 10 from the map
    mostPopular.take(10).foreach(hero => {
